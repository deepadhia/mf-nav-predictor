...
echo -e "${GREEN}==================================================================${NC}\n"
echo -e "• ${CYAN}Check 1 (Pre-Cutoff Pulse):${NC} 2:00 PM IST (08:30 UTC) Mon–Fri"
echo -e "• ${CYAN}Check 2 (Decision Cutoff):${NC} 2:15 PM IST (08:45 UTC) Mon–Fri"
echo -e "• ${CYAN}Nightly Accuracy Audit:${NC} 11:30 PM IST (18:00 UTC) Mon–Fri"
